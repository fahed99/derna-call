	...
	return (
		<>
			<div
				...
				onClick={onClick}
			>
				<div className="flex w-full text-grey-100 text-opacity-90 flex-row-reverse text-right items-center justify-between">
				...
				<div className="bg-primary-100 w-[100px] relative">
